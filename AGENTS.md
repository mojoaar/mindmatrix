...
- When asked "is docs updated?", "update docs", or similar — always check and update these files together: `/docs` pages (including `/docs/changelog`), `/apidocs` page, `README.md`, `AGENTS.md`, `plan.md`
